...
script = fso.BuildPath(root, "UpdateServerStatus.py")
...
If rc = 0 Then
  ...
  shell.Run rm & " !Refresh ""WindowsPorthexTheme\Server""", 0, True
  shell.Run rm & " !Refresh ""WindowsPorthexTheme\TaskbarStatus""", 0, False
End If
